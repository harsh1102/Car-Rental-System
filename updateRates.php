...
<nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="updateRates.php">Update Rates</a></li>
            </ul>
        </div>
    </nav> 
    <div class="container" style="margin-top:50px">
        <h2>Update Rental rates</h2>
        <form class="form-horizontal" action="updateRentalRates.php" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="dr" class="form-control" id="dr" placeholder="Enter Daily rates" name="dr" value = "">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="wr">weekly rates:</label>
                <div class="col-sm-10">
                    <input type="wr" class="form-control" id="wr" placeholder="Enter Weekly rates" name="wr" value = "">
                </div>
            </div>
            <div class="form-group">        
